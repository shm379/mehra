<template>
    <div class="flex flex-col gap-4">
        <div class="flex w-full flex-row gap-2 items-center justify-between" v-for="(item, i) in awards" :key="i">
            <div class="w-5/12">
...
import UiAutocompleteAward from "@/Components/Ui/Autocomplete/Award.vue";
