...
$(function () {
  ...
  if (dt_ajax_table.length) {
    var dt_ajax = dt_ajax_table.dataTable({
      ...
      ajax: assetPath+dt_ajax_id,
      processing: true,
      serverSide: true,
      columns: [
         {data: 'id', name: 'شناسه'},
         {data: 'title', name: 'عنوان'},
         {data: 'subtitle', name: 'عنوان جایگزین'},
         {data: 'price', name: 'قیمت'},
         {data: 'producer', name: 'تولید کننده'},
         {data: 'producer_type', name: 'نوع تولید کننده'},
      ]
    });
  }
